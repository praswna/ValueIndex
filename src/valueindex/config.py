...
WHALES = {
    ...
    "norges": {
        "name_ko": "노르웨이 국부펀드 (노르게스방크)", "cik": "0001374170", "region": "NO",
        "note": "세계 최대 국부펀드. 13F에는 미국 상장주식만 나오며, 수천 종목 초분산이라 "
                "개별 종목보다 상위 비중의 흐름을 봄.",
    },
    "ark": {
        "name_ko": "아크 인베스트 (캐시 우드)", "cik": "0001697748", "region": "US",
        "note": "혁신주 집중 투자로 유명한 캐시 우드. 회전율이 높아 분기마다 변화가 큼.",
    },
    "pershing": {
        "name_ko": "퍼싱스퀘어 (빌 애크먼)", "cik": "0001336528", "region": "US",
        "note": "행동주의 투자자 빌 애크먼. 10종목 안팎 초집중 포트폴리오.",
    },
    "renaissance": {
        "name_ko": "르네상스 테크놀로지", "cik": "0001037389", "region": "US",
        "note": "전설의 퀀트 헤지펀드(메달리온). 수천 종목 초분산 알고리즘 매매라 "
                "개별 종목의 의미는 낮고 규모·집중도 변화만 참고.",
    },
}
